function compute()
{
    ...
    //Check if the principal field is 0 or a negative value 
    ...
    document.getElementById("result").innerHTML="If you deposit <span class='highlight'>"+principal.value+"</span>,<br>"+
